import logging
from ncrypt0.x509 import X509Error
from ncrypt0.ssl import SSLConnection, SSLError
...
from cspace.network.sslutil import makeClientSSLContext
...
def serverCertVerifyCallback(conn, cert, errno, depth, preverify_ok):
    return preverify_ok
    
def _locationConnect( localUserName, localKeyId, localRSAKey, localPublicIP,
        remotePublicKey, remoteLocation, reactor, callback=None ) :
    sslContext = makeClientSSLContext( localUserName, localKeyId, localRSAKey, serverCertVerifyCallback )
...
def _userConnect( localUserName, localKeyId, localRSAKey, localPublicIP,
    ...
    def doConnectLocation() :
        obj.connectOp = _locationConnect( localUserName, localKeyId, localRSAKey,
...
def userServiceConnect( localUserName, localKeyId, localRSAKey, localPublicIP,
    ...
    connectOp = _userConnect( localUserName, localKeyId, localRSAKey, localPublicIP,
