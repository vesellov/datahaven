...
class MyTrafficWindow(wx.Frame):
    def __init__(self, parent):
        ...
        self.lst.SetColumnWidth(3, 170)
        self.lst.SetColumnWidth(4, 50)
        self.lst.SetColumnWidth(5, 300)
        self.lst.SetColumnWidth(6, 200)
        self.index = 0
    ...
    def add(self, parts):
        try:
            ...
            id = parts[6]
            status = parts[8]
            message = parts[9].replace('_', ' ').strip('"')
        except:
            WriteException()
        c = 'black'
        i = 0
...
class MyFrame(wx.Frame):
    def __init__(self, parent, ID, url, base_addr, base_port):
        ...
        if platform.uname()[0] == 'Windows': 
            ...
            self.SetStatusText('  \xa9 2006, DataHaven.NET LTD. of Anguilla.', 1)
        else:
            self.SetStatusWidths([-1, 340])
            self.SetStatusText(u'  \u00a9 2006, DataHaven.NET LTD. of Anguilla.'.encode('utf8'), 1)
